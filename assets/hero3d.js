/* hero3d.js v5 — Signal Halo system with GLSL vertex displacement */
(function () {
    'use strict';
    ...
    /* ═══════════════════════════════════════════════════
       GLSL — Halo ring material (displacement + iridescent)
    ═══════════════════════════════════════════════════ */
    var HALO_VERT = [
        'uniform float uTime;',
    ...
    var HALO_FRAG = [
        ...
        '  float f5 = f2 * f2 * fr;',
        '',
        '  /* iridescent hue shift from view angle */',
    ...
    /* ═══════════════════════════════════════════════════
       GLSL — Tier ring material (solid glowing arc)
    ═══════════════════════════════════════════════════ */
    var TIER_VERT = [
        'uniform float uTime;',
        'uniform float uActive;',
    ...
    /* ═══════════════════════════════════════════════════
       GLSL — Particle shader (soft circles)
    ═══════════════════════════════════════════════════ */
    var PART_VERT = [
    ...
    function boot() {
        ...
        /* master rig — everything lives here for global mouse rotation */
        var rig        = new THREE.Group();
        var haloRig    = new THREE.Group(); /* signal halos */
        var tierRig    = new THREE.Group(); /* 4 tier rings orbiting halo */
        ...
        /* ─────────────────────────────────────────────────
           SIGNAL HALOS — 3 nested displaced tori
        ───────────────────────────────────────────────── */
        var haloData = [
        ...
        /* ─────────────────────────────────────────────────
           TIER RINGS — 4 rings orbiting halo A
           at rest: stacked at slight offsets
           on pricing scroll: fan out horizontally
        ───────────────────────────────────────────────── */
        var tierRings = [];
        var tierUniforms = [];
        ...
        function renderFrame(ts) {
            ...
            /* Smooth mouse — much slower lerp for cinematic feel */
            ...
            /* ── Halo uniforms + slow independent rotation ── */
            ...
            tierRings.forEach(function (ring, ti) {
                ...
                /* At rest: rings orbit halo A slowly (stacked with slight tilt variety) */
                /* On pricing scroll: fan out to horizontal grid */
                var fan = ti - 1.5;   /* -1.5, -0.5, 0.5, 1.5 */
                var orbitRadius = 2.8 + (isAct * 0.3);

                /* orbit angle: slow drift, plus each ring offset by 90° */
                var orbitAngle = ring.userData.baseAngle + clock * (0.12 + ti * 0.018);

                /* rest position: inside halo A orbit */
                ...
                /* fan position: flat grid below halos */
                ...
                /* ring rotation: orbit tilt at rest, upright flat on pricing */
                ...
                /* scale: normal, enlarge on active/opening */
            ...
            /* ±40° mouse rotation — the dramatic upgrade */
        ...
        /* touch: treat touch as mouse for mobile scene reaction */
