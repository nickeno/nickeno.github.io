/* cursor.js — premium canvas cursor with chromatic aberration */
(function () {
    'use strict';
    ...
    /* ── state ── */
    var mx = 0, my = 0;
    var dx = 0, dy = 0;           // dot  (fast follower)
    var rx = 0, ry = 0;           // ring (slow follower)
    var pmx = 0, pmy = 0;         // prev mouse (for velocity)
    var vx = 0, vy = 0;           // velocity
    var speed = 0;                 // magnitude
    ...
    function frame() {
        ...
        if (ringR > 0.5) {
            ...
            /* chromatic aberration (only while moving) */
            if (caStrength > 0.6) {
